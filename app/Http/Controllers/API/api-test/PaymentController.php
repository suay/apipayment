...
class PaymentController extends Controller
{
    ...
    public function charge2c2p(Request $request)
    {
      ...
      if ( empty( $request->input('currency') ) ){
        ...
        $min = date('his');
    	//$urlpay = env('URL2C2P');
    	$secret_key = 'D97EE54180CF124D12961DB49A21BBF4D6C1AE3A8545CF062DC0517EDD3A7F04';//env('SECRET_KEY2C2P');//production
    ...
    public function responseback(Request $request)
    {
      ...
      /* ======================= case check first payment recurring 
        ...
        /*==== check case reject response code !=00 */
        //if( $all['channel_response_code']!="00" && empty($check_is_recurring) ){ //is recurring response only
          ...
          //curl call api update status to subspened and send email to customer
            ...
            curl_setopt_array($curl, array(
              CURLOPT_URL => 'https://staging2.netkasystem.com/itsmstore/api/updatestatus.php',//https://netkasystem.com/itsmstore/api/
              CURLOPT_RETURNTRANSFER => true,
              CURLOPT_ENCODING => '',
              CURLOPT_MAXREDIRS => 10,
              CURLOPT_TIMEOUT => 0,
